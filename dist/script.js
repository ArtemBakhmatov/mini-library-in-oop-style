...
/*!********************************!*\
  !*** ./src/js/customizator.js ***!
  \********************************/
/*! exports provided: Customizator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Customizator", function() { return Customizator; });
  ...
  _createClass(Customizator, [{
    ...
    value: function onScaleChange(event) {
      ...
      var recursy = function recursy(element) {
        // фу-ю прописали из-за this.scale на 23 и 26 строке
        element.childNodes.forEach(function (node) {
          if (node.nodeName === '#text' && node.nodeValue.replace(/\s+/g, '').length > 0) {
            if (!node.parentNode.getAttribute('data-fz')) {
              ...
              node.parentNode.style.fontSize = node.parentNode.getAttribute('data-fz') * _this2.scale + 'px'; // +value.replace(/px/g, '') -> 50px получиться 50 и он будет числовым типом данных
            } else {
...
window.addEventListener('DOMContentLoaded', function () {
  var panel = new _customizator__WEBPACK_IMPORTED_MODULE_0__["Customizator"]();
  panel.render();
});
